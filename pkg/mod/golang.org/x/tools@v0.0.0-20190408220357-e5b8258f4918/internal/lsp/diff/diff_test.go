...
func TestDiff(t *testing.T) {
	for _, test := range []struct {
	...
	}{
		{
			...
			b: "C\nB\nA\nB\nA\nC\n",
			operations: []*Op{
				{Kind: Delete, I1: 0, I2: 1, J1: 0},
				{Kind: Delete, I1: 1, I2: 2, J1: 0},
				{Kind: Insert, Content: []string{"B\n"}, I1: 3, I2: 3, J1: 1},
				{Kind: Delete, I1: 5, I2: 6, J1: 4},
				{Kind: Insert, Content: []string{"C\n"}, I1: 7, I2: 7, J1: 5},
			},
		},
		{
			a: "A\nB\n",
